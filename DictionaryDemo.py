...
# characteristics of dictionary data type(key-value pair)
# Data : Heterogeneous
# Ordered : Yes
# **Indexed : No
# Mutable : Yes
...
programming = {"C" : "Ritchie", "C++" : "Stroutup", "Java" : "Gosling" , "Python" : "Rossum" , "C" : "Thompson"}
...
print("Value of PPA is :", programming)